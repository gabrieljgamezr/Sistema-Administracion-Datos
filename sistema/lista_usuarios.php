...
<body>
	...
	<section id="container">
		...
		<?php
			...
			$query = mysqli_query($conection, "SELECT u.ID_USUARIO, u.NOMBRE, u.USUARIO, r.ROL FROM `usuarios` u INNER JOIN `rol` r ON u.ID_ROL = r.ID_ROL ORDER BY r.ROL ASC, u.ID_USUARIO ASC LIMIT $desde,$por_pagina;");
