...
<table>
	...
	<?php
		...
		$query2 = mysqli_query($conection, "SELECT c.`ID CARGA FAMILIAR`,c.`ID`,c.`PRIMER APELLIDO`,c.`SEGUNDO APELLIDO`,c.`PRIMER NOMBRE`,c.`SEGUNDO NOMBRE`,c.`CEDULA`,c.`PARENTESCO`,c.`FECHA DE NACIMIENTO`,c.`NIVEL DE ESTUDIO`,c.`POSEE ALGUNA CONDICION ESPECIAL`, `OBSERVACIONES` FROM `carga familiar` c WHERE c.`ID` = '$ID' ORDER BY c.`ID` ASC;");
		mysqli_close($conection);
...
<table class="tabla_ficha">
	...
	<tr>
		...
		<td><?php echo $data2['PRIMER APELLIDO']; ?></td>
		<td><?php echo $data2['SEGUNDO APELLIDO']; ?></td>
		<td><?php echo $data2['PRIMER NOMBRE']; ?></td>
		<td><?php echo $data2['SEGUNDO NOMBRE']; ?></td>
		<td><?php echo $data2['CEDULA']; ?></td>
		<td><?php echo $data2['PARENTESCO']; ?></td>
		<td><?php echo $data2['FECHA DE NACIMIENTO']; ?></td>
		<td><?php echo $data2['NIVEL DE ESTUDIO']; ?></td>
		<td><?php echo $data2['POSEE ALGUNA CONDICION ESPECIAL']; ?></td>
		<td><?php echo $data2['OBSERVACIONES']; ?></td>
